...
function Pengguna() {
  const stats = [
    {
      label: "Siswa kami",
      value: 40,
      icon: <FaUsers size={30} className="text-green-600 mr-2" />, // Icon next to text
      suffix: "", // No suffix for this stat
    },
    {
      label: "Jumlah Module",
      value: 20,
      icon: <FaCheckCircle size={30} className="text-green-600 mr-2" />, // Icon next to text
      suffix: "", // No suffix for this stat
    },
    {
      label: "Kepuasan Siswa Kami",
      value: 65,
      icon: <FaSmileBeam size={30} className="text-green-600 mr-2" />, // Icon next to text
  ...
  return (
    <div
      id="pengguna"
      className="w-full py-20 px-4 bg-gradient-to-br from-green-50 to-white relative overflow-hidden" // Enhanced background and overflow-hidden
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10"> {/* Ensure content is above background elements */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-gray-800 mb-16 tracking-tight leading-tight">
          Pencapaian <span className="text-green-600">Terbaik Kami</span>
        </h2>
